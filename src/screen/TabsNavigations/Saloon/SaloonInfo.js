...
const mapStateToProps = (state) =>{
    return{
        services: state.selectedSaloonBookingReducer.data.services ,
        stylist: state.selectedSaloonBookingReducer.data.serviceProviders,
        portfolioImg: state.selectedSaloonBookingReducer.data.portfolioImages
    }
}
export default connect(mapStateToProps,null)(SaloonInfo);
