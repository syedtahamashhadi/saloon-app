                ...
                <View style={{marginHorizontal:20,marginTop:20}}>
                    ...
                    <View>
                        <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:5}}>
                            ...
                            <Text style={{fontSize:16,fontFamily:'AbrilFatFace'}}>{props.service}</Text>

                        </View>
                        <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:8}}>
                            <Text style={{fontSize:15,color:'grey',fontFamily:'ExoRegular'}}>Duration:</Text>
                            <Text style={{fontSize:16,fontFamily:'AbrilFatFace'}}>{props.duration}</Text>

                        </View>
                        <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:8}}>
                            <Text style={{fontSize:15,color:'grey',fontFamily:'ExoRegular'}}>Staff:</Text>
                            <Text style={{fontSize:16,fontFamily:'AbrilFatFace'}}>{props.staff}</Text>

                        </View>
                        <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:8}}>
                            <Text style={{fontSize:15,color:'grey',fontFamily:'ExoRegular'}}>Total:</Text>
                                <Text style={{fontSize:16,fontFamily:'AbrilFatFace'}}>{props.total}</Text>
