...
const SvgMapPointerMarker = (props) =>{
...
<style type="text/css">
	...
	.st103{opacity:0.3;fill:#F7B500;enable-background:new    ;}
	.st104{fill:none;stroke:#FFFFFF;stroke-width:0.33;stroke-miterlimit:10;}
</style>
<g>
	<rect x="6.7" y="8.8" class="st14" width="0.7" height="8"/>
	<path class="st14" d="M7,13.5c3.7,0,6.7-3,6.7-6.7s-3-6.7-6.7-6.7c-3.7,0-6.7,3-6.7,6.7S3.3,13.5,7,13.5z"/>
	<path class="st104" d="M7,13.5c3.7,0,6.7-3,6.7-6.7s-3-6.7-6.7-6.7c-3.7,0-6.7,3-6.7,6.7S3.3,13.5,7,13.5z"/>
	<circle class="st14" cx="7" cy="17.8" r="1"/>
</g>
</svg>
    ...
    const MapPointerMarker = () => <SvgXml xml={svg} width='100%' height='100%' fill='#FA7268'/>
    return <MapPointerMarker />
}

export default SvgMapPointerMarker;