...
const SvgDodHeart = (props) =>{
    ...
    <path class="st4" d="M9.2,18.3c5.1,0,9.2-4.1,9.2-9.2c0-5.1-4.1-9.2-9.2-9.2C4.1,0,0,4.1,0,9.2C0,14.2,4.1,18.3,9.2,18.3z"/>
    <path class="st21" d="M12.9,6.7c-0.3-0.7-0.9-1.1-1.6-1.2C10.7,5.4,10,5.6,9.5,6.1L9.3,6.4c-0.1,0.1-0.1,0.1-0.2,0L8.9,6.1
        C8.4,5.6,7.7,5.4,7,5.5C6.3,5.6,5.7,6.1,5.4,6.7C5,7.6,5.1,8.6,5.8,9.3L9,12.7c0,0.1,0.1,0.1,0.2,0.1c0.1,0,0.2,0,0.2-0.1l3.1-3.4
        C13.2,8.6,13.4,7.6,12.9,6.7z"/>
    </svg>
    
    `

    const DodHeart = () => <SvgCss xml={svg} width={props.width} height={props.height} />     
    
    return <DodHeart/>
}

export default SvgDodHeart;