...
const SvgFooterBarBack = (props) =>{

    const svg = `
    <?xml version="1.0" encoding="utf-8"?>
    <!-- Generator: Adobe Illustrator 24.1.1, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 6.7 5.2" style="enable-background:new 0 0 6.7 5.2;" xml:space="preserve">
    <style type="text/css">
    ...
    <path class="st14" d="M6.6,1.7L4.9,0.1C4.8,0,4.7,0,4.6,0.1c-0.1,0-0.1,0.1-0.1,0.2v0.7H2.9C2.7,0.9,2.6,1,2.6,1.2s0.1,0.2,0.2,0.2
        h1.9C4.9,1.4,5,1.3,5,1.2V0.8l1.1,1.1L5,2.9V2.6c0-0.1-0.1-0.2-0.2-0.2H2.1V1.6c0-0.1-0.1-0.2-0.2-0.2c-0.1,0-0.1,0-0.2,0.1L0.1,3.1
        C0,3.2,0,3.4,0.1,3.4l1.7,1.6c0,0.1,0.1,0.1,0.2,0.1c0,0,0.1,0,0.1,0c0.1,0,0.2-0.1,0.2-0.2V4.2h1.7C3.9,4.2,4,4.1,4,4
        S3.9,3.7,3.8,3.7H1.9C1.8,3.7,1.7,3.9,1.7,4v0.4L0.6,3.3l1.1-1.1v0.4c0,0.1,0.1,0.2,0.2,0.2h2.6v0.7c0,0.1,0.1,0.2,0.2,0.2
        c0.1,0,0.1,0,0.2-0.1L6.6,2C6.7,1.9,6.7,1.8,6.6,1.7z"/>
    </svg>
    
    `

    const FooterBarBack = () => <SvgXml xml={svg} width={props.width} height={props.height} fill='#ffff' />     
    
    return <FooterBarBack/>
}

export default SvgFooterBarBack;