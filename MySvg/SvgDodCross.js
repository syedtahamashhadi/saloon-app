...
<path class="st45" d="M9.2,18.3c5.1,0,9.2-4.1,9.2-9.2c0-5.1-4.1-9.2-9.2-9.2C4.1,0,0,4.1,0,9.2C0,14.2,4.1,18.3,9.2,18.3z"/>
<line class="st90" x1="6" y1="12.3" x2="12.3" y2="6"/>
<line class="st90" x1="12.3" y1="12.3" x2="6" y2="6"/>
</svg>
    
    `

    const DodCross = () => <SvgCss xml={svg} width={props.width} height={props.height} />     
    
    return <DodCross/>
}

export default SvgDodCross;