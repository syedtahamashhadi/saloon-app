...
const SvgFooterBarProfile = (props) =>{
...
<path class="st21" d="M4.7,6.2c-0.9,0-1.6-0.7-1.6-1.6c0-0.9,0.7-1.6,1.6-1.6c0.9,0,1.6,0.7,1.6,1.6C6.2,5.5,5.5,6.2,4.7,6.2z
    ...
    const FooterBarProfile = () => <SvgXml xml={svg} width={props.width} height={props.height} fill='#fff' />     
    
    return <FooterBarProfile/>
}

export default SvgFooterBarProfile;