...
const SvgSaloonListViewBar = (props) =>{
    ...
    <path class="st14" d="M4,4.5V4.2C4,4.1,3.9,4,3.8,4H2.2C2.1,4,2,4.1,2,4.2v0.3c0,0.1,0.1,0.2,0.2,0.2h1.7C3.9,4.7,4,4.6,4,4.5z
         M5,2.5V2.2C5,2.1,4.9,2,4.8,2H1.2C1.1,2,1,2.1,1,2.2v0.3c0,0.1,0.1,0.2,0.2,0.2h3.7C4.9,2.7,5,2.6,5,2.5z M5.8,0.7H0.2
        C0.1,0.7,0,0.6,0,0.5V0.2C0,0.1,0.1,0,0.2,0h5.7C5.9,0,6,0.1,6,0.2v0.3C6,0.6,5.9,0.7,5.8,0.7z"/>
    </svg>
    
    
    `

    const SaloonListViewBar = () => <SvgCss xml={svg} width='100%' height='100%' />
    return <SaloonListViewBar />
}

export default SvgSaloonListViewBar;