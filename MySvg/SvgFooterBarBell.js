...
const SvgFooterBarBell = (props) =>{
    ...
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 6.7 9.3" style="enable-background:new 0 0 6.7 9.3;" xml:space="preserve">
    <style type="text/css">
    ...
    <path class="st4" d="M6.3,7.8C6.3,7.8,6.2,7.9,6.3,7.8L0.5,7.9c-0.1,0-0.1,0-0.1-0.1c0,0,0-0.1,0-0.1l0.4-0.8h5l0.4,0.8
        C6.3,7.7,6.3,7.8,6.3,7.8z M3.4,8.8C3,8.8,2.8,8.6,2.7,8.3H4C3.9,8.6,3.7,8.8,3.4,8.8z M0.9,4.6c0-1.3,1.1-2.4,2.4-2.4
        c1.3,0,2.4,1.1,2.4,2.4v1.9H0.9V4.6z M3,0.8c0-0.2,0.2-0.4,0.4-0.4s0.4,0.2,0.4,0.4v1c-0.1,0-0.2,0-0.4,0s-0.3,0-0.4,0V0.8z
         M6.6,7.5L6.2,6.6V4.6c0-1.3-0.9-2.4-2-2.7v-1C4.1,0.4,3.8,0,3.4,0S2.6,0.4,2.6,0.8v1c-1.2,0.3-2,1.4-2,2.7v2.1L0.1,7.5
        C0,7.7,0,7.9,0.1,8c0.1,0.2,0.3,0.3,0.5,0.3h1.8c0,0.5,0.5,1,1,1s1-0.4,1-1h1.8c0.2,0,0.3-0.1,0.5-0.3C6.7,7.9,6.7,7.7,6.6,7.5z"/>
    <path class="st4" d="M3.4,2.7c-1,0-1.9,0.8-1.9,1.9c0,0.1,0.1,0.2,0.2,0.2c0.1,0,0.2-0.1,0.2-0.2c0-0.8,0.7-1.4,1.5-1.4
        c0.1,0,0.2-0.1,0.2-0.2C3.6,2.8,3.5,2.7,3.4,2.7z"/>
    </svg>
    

    `

    const FooterBarBell = () => <SvgXml xml={svg} width={props.width} height={props.height} fill='#fff' />     
    
    return <FooterBarBell/>
}

export default SvgFooterBarBell;