...
const SvgMapScisorMarker = (props) =>{
    ...
    <g id="Map-Point" transform="translate(25 1)">
            ...
            <rect id="Rectangle_1_" x="-8.9" y="4.2" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -6.6329 -3.9177)" class="st1" width="1.6" height="3.8"/>
        
            <rect id="Rectangle-2" x="-5.8" y="1.1" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -3.5842 -2.6555)" class="st1" width="1.6" height="3.8"/>
    ...
    const MapScisorMarker = () => <SvgCss xml={svg} width='100%' height='100%' />
    return <MapScisorMarker />
}

export default SvgMapScisorMarker;